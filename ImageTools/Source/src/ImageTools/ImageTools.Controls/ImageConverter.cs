    ...
    public class ImageConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (value != null)
            {
                ...
                {
                    isStreaming = (bool)parameter;
                }
                else
                {
                    var imageParameters = parameter as ExtendedImage.ExtendedImageParameters;

                    if (imageParameters != null)
                    {
                        isStreaming = imageParameters.IsStreaming;
                        isPreprocessed = imageParameters.IsPreprocessed;
                    }
                }
                ...
                if (sourceAsUri != null)
                {
                    var extendedImage = new ExtendedImage { IsStreaming = isStreaming, IsPreprocessed = isPreprocessed };
                    extendedImage.Referer = this.Referer;
