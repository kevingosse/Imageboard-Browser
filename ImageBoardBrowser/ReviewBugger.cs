...
namespace System
{
    public static class ReviewBugger
    {
        ...
        {
            return numOfRuns % numOfRunsBeforeFeedback == 0;
        }
        ...
        public static void PromptUser()
        {
            ...
            messagePrompt.Message = "If you like this application, you can help by rating it or writing a review. Would you like to rate " + App.ViewModel.ApplicationTitle + " now?";
